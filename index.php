...
<?php
    ...
    <section class="section1" >
        <h1>¿Testimonios?</h1>
        <p>
            <b>Pol:</b> Son muy buenos los trabajadores, estupendo trato hacia los clientes. Un dia jugé un torneo en el que me inscribió mi profesor, una auténtica pasada, lo pasamos en grande ademas de hacer nuevos amigos con los que podré pasar rato jugando a padel
            </br><b>Carlos:</b>  "Las instalaciones son de primera calidad y siempre están bien mantenidas. He mejorado mucho mi juego gracias a las clases con los profesores, quienes son muy profesionales y atentos." 
            </br><b>Marta:</b> "Me encanta el ambiente en Pádel Club. Los torneos son muy bien organizados y competitivos, pero siempre hay un espíritu de camaradería. ¡Es el mejor lugar para jugar al pádel!"
            </br><b>Germán:</b> "Reservar pistas es muy fácil y siempre hay disponibilidad. Mis amigos y yo solemos venir los fines de semana para pasar un buen rato. Además, el ranking de jugadores es una excelente manera de ver nuestro progreso." 
            </br><b>Diana:</b>  "La primera vez que tomé una clase aquí, supe que era el lugar adecuado para mejorar mi juego. Los profesores son increíbles y te motivan a dar lo mejor de ti. ¡Recomendado al 100%!"
            </br><b>Alex:</b>  "El ranking de profesores es muy útil para elegir con quién tomar clases. Todos son muy buenos, pero poder ver quiénes son los más populares me ha ayudado a tomar decisiones informadas. ¡Excelente idea!" 
        </p>
    </section>
